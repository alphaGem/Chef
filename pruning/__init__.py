...
from .BMPruneLoss import BMPruneLossController, BrutePenalty, GPT2SizeCalculator
from .BMPruneStrategy import BMPruneStrategy, MHALayerPruning
...
class BMPrune:
    def set_forward(
        ...
        for strategy in strategies:
            ...
            strategy.inject_loss(prune_loss_controller.size_calculator)
